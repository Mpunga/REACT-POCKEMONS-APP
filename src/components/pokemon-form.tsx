...
const PokemonForm: FunctionComponent<Props> = ({ pokemon, isEditForm}) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (isFormValid) {
            ...
            pokemon.hp = parseInt(form.hp.value);
            pokemon.cp = parseInt(form.cp.value);
    ...
    const validateForm = () => {
        ...
        if (isAddForm()) {
            ...
            if (!form.picture.value.startsWith(start) || !form.picture.value.endsWith(end)) {
                const errorMsg = `L'URL de l'image doit commencer par ${start} et se terminer par ${end}.`;
                ...
                <div className='col s12 m8 offset-m2'>
                    <div className="card hoverable">
                        ...
                        <div className="card-image">
                            ...
                            <span className='btn-floating halfway waves-effect waves-light'>
